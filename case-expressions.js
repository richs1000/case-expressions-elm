...
var _user$project$CaseExpressions$subscriptions = function (model) {
	return _user$project$Ports$ssData(_user$project$MessageTypes$GetValuesFromSS);
};
var _user$project$CaseExpressions$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Model$init, view: _user$project$View$view, update: _user$project$Update$update, subscriptions: _user$project$CaseExpressions$subscriptions})
};

var Elm = {};
Elm['CaseExpressions'] = Elm['CaseExpressions'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['CaseExpressions'], 'CaseExpressions', typeof _user$project$CaseExpressions$main === 'undefined' ? null : _user$project$CaseExpressions$main);
